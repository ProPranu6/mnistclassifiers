...
arch = [('input',Xtrain.shape[0],Xtrain.shape[1],Xtrain.shape[2],1), ('conv',5,5,6,1,"SAME"),('maxpool',2,2,2,"VALID"),('conv',5,5,16,1,"VALID"),('maxpool',2,2,2,"VALID"),('Flatten',),('fc',120),('fc',84),('fc',10),('softmax',10)]

parameters, Ypredi = MyModel.model(Xtrain, Ytrain, Xtest, Ytest, arch, learning_rate = 0.007, epochs= 10, printCost=True)
